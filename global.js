...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="background"><img src="slide1/s1.png" width="1024" height="768" alt=""></div><div class="hand"><img src="slide1/s2.png"></div><div class="hit_1"><img src="slide1/s3.png" width="1024" height="768" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="stamp"><img src="slide1/s4.png"></div><div class="hit_close1" onclick="hit_close1()"></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="background"><img src="slide2/s1.png" width="1024" height="768" alt=""></div><div class="pointer"><img src="slide2/s2.png"></div><div class="hand"><img src="slide2/s3.png"></div><div class="kol" onclick="kol();"></div><video id="myVideo" width="1024" height="768" src="slide2/s3.mp4" controls></video><div class="closekol" onclick="closekol();"><img src="slide2/close.png"></div></div><div class="hit_1"><img src="slide2/s4.png" width="1024" height="768" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="stamp"><img src="slide2/s5.png"></div><div class="hit_close1" onclick="hit_close1()"></div>';
	break;
}
